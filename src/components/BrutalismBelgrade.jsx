...
<div className="photo-container">
    <div class="overlay" onClick={() => handleClick(image51)} >
      <div class="text" >A post office near the central bus station</div>
    </div>
  <img src={image51} alt="belgrade51" className="photo" onClick={() => handleClick(image51)} />
</div>
